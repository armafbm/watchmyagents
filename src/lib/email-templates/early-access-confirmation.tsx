    ...
    <Body style={main}>
      <Container style={container}>
        ...
        <Section style={card}>
          ...
          <Text style={text}>
            Your AI agents — under protection. Watch detects, Shield enforces, Guardian explains.
            We're onboarding teams in waves and we'll come back to you very soon with your access
            details.
          </Text>
          <Text style={text}>
            In the meantime, if you want to tell us about the agents you're shipping, just reply to
