...
const TIERS: Tier[] = [
  ...
  },
  {
    ...
    monthlyPrice: 79,
    monthlyAnnual: 55.3,
    priceIdMonthly: "pro_plus_monthly",
    priceIdYearly: "pro_plus_yearly",
    features: [
      "Security Score",
      "Cost Optimization",
      "1-year history",
            ...
            {TIERS.map((t) => {
              ...
              return (
                ...
                >
                  ...
                  {isPaid ? (
                    <button onClick={() => handleSubscribe(t)} className={btnClass}>
                      {t.cta}
                    </button>
                  ) : t.ctaHref?.startsWith("mailto:") ? (
                    <a href={t.ctaHref} className={btnClass}>
                      {t.cta}
                    </a>
                  ) : (
                    <Link to={t.ctaHref!} className={btnClass}>
                      {t.cta}
                    </Link>
                  )}
                </div>
          ...
          <div className="max-w-3xl mx-auto px-4 py-8">
            <div className="flex justify-between items-center mb-6">
              ...
              <button
                ...
                className="h-9 w-9 grid place-items-center rounded-md border border-border/60 hover:border-primary/60 transition"
                aria-label="Close"
              >
                <X className="h-4 w-4" />
              </button>
