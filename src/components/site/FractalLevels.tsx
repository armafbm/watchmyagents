    ...
    <section id="fractal-levels" className="relative py-20 border-t border-border/40">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 relative">
        <div className="text-center max-w-3xl mx-auto mb-10">
          <div className="eyebrow mb-3">// 02 — Four fractal levels</div>
          <h3 className="text-3xl md:text-4xl font-bold mb-4">
            The same loop, at <span className="text-gradient">every scale</span>
          </h3>
          <p className="text-muted-foreground text-base leading-relaxed">
            The Watch → Guardian → Shield loop runs recursively — on a single agent, on a team, on a
            full multi-agent system, and across your whole organization.
          </p>
        </div>
